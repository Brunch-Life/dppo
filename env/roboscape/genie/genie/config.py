...
class GenieConfig:
    ...
    action_dim: int = 16  # action dimension
    text_dim: int = 768
    ...
    max_corrupt_rate: float = (
        0.2  # Corrupt all tokens, uniform between [0, max_corrupt_rate]
    )
    # Case 1: MLM training.
    ...
    def __post_init__(self):
        self.factored_vocab_size = nth_root(
            self.image_vocab_size, self.num_factored_vocabs
        )
